...
<html <?php language_attributes(); ?>>
    <head>
        ...
        <meta property="og:url" content="http://maguare.gov.co/" />
        <meta property="og:site_name" content="Maguaré - Ministerio de Cultura de Colombia" />
        <meta property="og:image" content="http://maguare.gov.co/wp-content/uploads/2017/12/op_maguare.jpg" />
        <?php wp_head(); ?>
    </head>
    ...
    <body <?php body_class('mg'); ?>>
        <div id="page" class="site">
            ...
            <!-- End Modal Home -->
            <main class="mg__section-page mg__escuchar" data-page-modal>
                <!-- Start Global Header -->
                <header class="header">
