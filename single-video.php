                        ...
                        <div class="note__content" data-expand>
                            ...
                            <div class="note__media note__media--video">
                                <div class="note__media__container">
                                    <?php /*
                                    $link_youtube = get_field('url_video');
                                    $loc = explode( "/", $link_youtube  );
                                    $videoid = end($loc); ?>
                                    <iframe id="player-maguare" src="https://www.youtube.com/embed/<?php echo  $videoid;?>?enablejsapi=1&origin=https://staging.maguare.gov.co?rel=0&amp;showinfo=0&autoplay=1" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen=""></iframe>  */ ?>
                                    <div id="player-maguare"></div>
                                </div>
                                <p class="text-note text-color-brown">
                                    <?php the_field('descripcion'); ?>
                                </p>
                                <?php if (get_field('resena_video')): ?> 
                                    <p class="maguare_resena">
                                        <?php the_field('resena_video'); ?>
                                    </p>
                                <?php endif; ?>
                    ...
                    <div class="notes-list notes-list--short">
                        <div class="mg-slider" data-slider-color="yellow">
                            ...
                            <div class="notes-list__container">
                                ...
                                <?php get_template_part( 'template-parts/content', 'contenidos-relacionados-video' ); ?>
                                <?php $i++; 
                                if($i != 0 && $i % 3 == 0) { ?>
