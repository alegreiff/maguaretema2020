<?php
/**
 * Template Name: Sección Bailar
 * Plantilla Sección Bailar.
 *
 * @package maguare
 */
get_header('bailar'); ?>
...
if ( is_page('bailar')) {
    $link_contenido = "link-1--purple-light";
}
?>
            ...
            <div class="section-page__wrapper">
                ...
                <section class="section-page">
                    <div class="main-slider-notes-container main-slider-notes-container--white">
                        <div class="page-slider-notes mg-slider" data-slider-color="purple-light">
