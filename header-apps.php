...
<html <?php language_attributes(); ?>>
    ...
    <body <?php body_class('mg'); ?>>
        <div id="page" class="site">
            ...
            <!-- End Modal Home -->
            <main class="mg__section-page mg__jugar" data-page-modal='app'>
                <!-- Start Global Header -->
                <header class="header">
                    <div class="header__wrapper">
                        ...
                        <div class="header__share">
                            ...
                            <!--<a href="<?php echo get_theme_mod( 'url_social_instagram');?>" class="button button--share button--share-in" target="_blank"></a>-->
