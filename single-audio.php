...
if(get_field('mag_contenido_relacionado_maguared')){
    $clase_actividad='icon-m-audio mag_contenido_relacionado_maguared';
}else{
    $clase_actividad='icon-m-audio';
}
?>
                ...
                <section class="section-page">
                    <article class="note note--media">
                        <div class="note__content" data-expand>
                            ...
                            <div class="note__media note__media--audio">
                                <div class="note__media__container">
                                    <figure>
                                        ...
                                        <i class="note__content--icon <?php echo $clase_actividad; ?>"></i>
                            ...
                            <?php
                                if( get_field('letra_cancion')){
                                    ?>
                                <div class="text-note text-color-brown">
                                <h5 class="letra-cancion">-- Letra --</h5>
