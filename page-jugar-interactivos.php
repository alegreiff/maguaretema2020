<?php
/**
 * Template Name: Jugar Interactivos
 * Plantilla Jugar Interactivos.
 *
 * @package maguare
 */
get_header('interactivos'); ?>
            ...
            <div class="section-page__wrapper">
                ...
                <section class="section-page">
                    <div class="notes-list-title-image">
                        ...
                        $interactivos_apps = get_field('destacados_interactivos', false, false);
                        $args = array (
                            'post_type'      	     => 'post',
                            'post__in'			     => $interactivos_apps,
                            'posts_per_page'         =>	 3,
                            'orderby'        	     => 'post__in',
                        );
                        // The Query
                        ...
                        <?php
                                ...
                                get_template_part( 'template-parts/content', 'contenidos-destacados-interactivos' );
                        ?>
                        <?php   }
                        } else { ?>
                ...
                <section class="section-page content-notes-list">
                    <div class="notes-list">
                        ...
                        <div class="notes-list__container">
                            ...
                            // args
                            $count=0;
                            $interactivos_seccion = get_field('interactivos_seccion', false, false);
                            $args = array (
                                'post_type'      	     => 'post',
                                'post__in'			     => $interactivos_seccion,
                                'posts_per_page'         =>	 -1,
                                'orderby'        	     => 'post__in',
                            );
                            // query
                            ...
                            /* Include the Post-Format-specific template for the content.
                                     * If you want to override this in a child theme, then include a file
                                     * called content-___.php (where ___ is the Post Format name) and that will be used instead.*/
                            get_template_part( 'template-parts/content', 'interactivos-seccion' );
                            ?>
                            <?php
                            $count++;
