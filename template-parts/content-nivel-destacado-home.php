<?php
/**
 * Template part for displaying page content in content-nivel-destacado-home.php
 *
...
?>
        ...
        <?php } ?>
            ...
            <div class="note__content">
                ...
                <?php if($cat  == 'APP' || $cat == 'Interactivo'){ ?>
                <a class="link-1 link-1--wine" href="#">
                    Ver más
                </a>
                <?php } else { ?>
                <a class="link-1 link-1--wine" href="<?php the_permalink(); ?>">
                    Ver más
                </a>
                <?php } ?>
            </div>
