<?php
/**
 * Template part for displaying page content in content-apps-seccion.php
 *
...
?>
        ...
        ?>
        <article class="note note--short" data-note-modal='app' data-url-appstore="<?php the_field('enlace_tienda_ios'); ?>" data-url-playstore="<?php the_field('enlace_tienda_android'); ?>" data-url-pc="<?php the_field('enlace_externo'); ?>">
            <div class="note__content">
                <h2 class="heading-note text-color-brown" data-note-head>
                    <?php the_title();?>
                </h2>
                <p class="text-note text-color-brown hidden-text" data-note-body>
                    <?php
