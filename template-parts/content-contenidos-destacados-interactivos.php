<?php
/**
 * Template part for displaying page content in content-contenidos-destacados-interactivos.php
 *
...
?>
        ...
        ?>
        <article class="note" data-note-modal='interactive' data-url-interactive="<?php the_field('url_interactivo'); ?>">
