<?php
/**
 * Template Name: Jugar Vídeo
 * Plantilla Jugar Vídeo.
 *
 * @package maguare
 */
get_header('jugar'); ?>
            ...
            <div class="section-page__wrapper">
                ...
                <section class="section-page">
                    <div class="notes-list-title-image">
                        ...
                        $destacados_video = get_field('destacados_video', false, false);
                        $args = array (
                            'post_type'      	     => 'post',
                            'post__in'			     => $destacados_video,
                            'posts_per_page'         =>	 3,
                            'orderby'        	     => 'post__in',
                        );
                        // The Query
                        ...
                        <?php
                                ...
                                get_template_part( 'template-parts/content', 'contenidos-destacados-video' );
                        ?>
                        <?php   }
                        } else { ?>
                ...
                <section class="section-page content-notes-list">
                    <div class="notes-list">
                        ...
                        <div class="notes-list__container">
                            ...
                            // args
                            $count=0;
                            $videos_seccion = get_field('videos_seccion', false, false);
                            $args = array (
                                'post_type'      	     => 'post',
                                'post__in'			     => $videos_seccion,
                                'posts_per_page'         =>	 -1,
                                'orderby'        	     => 'post__in',
                            );
                            // query
                            ...
                            /* Include the Post-Format-specific template for the content.
                                     * If you want to override this in a child theme, then include a file
                                     * called content-___.php (where ___ is the Post Format name) and that will be used instead.*/
                            get_template_part( 'template-parts/content', 'videos-seccion' );
                            ?>
                            <?php
                            $count++;
