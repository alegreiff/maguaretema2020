                        ...
                        <div class="note__content" data-expand>
                            ...
                            <div class="note__media note__media--video">
                                <div class="note__media__container">
                                 <?php
                                    $link_youtube = get_field('url_lista_video');
                                    $loc = explode( "/", $link_youtube  );
                                    $videoid = end($loc);?>
                                   <iframe src="https://www.youtube.com/embed/<?php echo  $videoid;?>&autoplay=1&loop=1" frameborder="0" gesture="media" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                                </div>
